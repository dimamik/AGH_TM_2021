...
HD_PWD='/home/student/Dzmitry_Mikialevich/dzmitrymikialevich/dzmitrymikialevich.runs/mem_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_blk_mem_gen_0_0.tcl
