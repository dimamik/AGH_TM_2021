                                                ...
                                                uint8_t lun)
{
  ...
  case BOT_CMD_SEND:  
    ...
    // moze tutaj
    xprintf("USBH_MSC_SCSI_TestUnitReady data: lun = %d\n", lun);
                                               ...
                                               SCSI_CapacityTypeDef *capacity)
{
  ...
  case BOT_CMD_SEND:  
    ...
    // moze tutaj
    xprintf("USBH_MSC_SCSI_ReadCapacity data: lun = %d\n", lun);
                                               ...
                                               SCSI_StdInquiryDataTypeDef *inquiry)
{
  ...
  case BOT_CMD_SEND:  
    ...
    // może tutaj
    xprintf("USBH_MSC_SCSI_Inquiry data: lun = %d\n", lun);
                                               ...
                                               SCSI_SenseTypeDef *sense_data)
{
  ...
  case BOT_CMD_SEND:  
    ...
    // może tutaj
    xprintf("USBH_MSC_SCSI_RequestSense data: lun = %d\n", lun);
                                     ...
                                     uint32_t length)
{
  ...
  case BOT_CMD_SEND:  
    ...
    xprintf("USBH_MSC_SCSI_WRITE data: lun = %d, address = %ld, pbuf = %d, length = %ld\n", lun, address, pbuf, length);
                                     ...
                                     uint32_t length)
{
  ...
  case BOT_CMD_SEND:  
    ...
    // być może tutaj
    xprintf("USBH_MSC_SCSI_Read data: lun = %d, address = %ld, pbuf = %d, length = %ld\n", lun, address, pbuf, length);
