...
//  BSP_LCD_FillRect(0, 0, 100, 100); // rysuje czerwony kwadrat, o wymiarach 50x50 (50 to strzał bo nie wiem jak sie wyswietli, więc to do ewentualnej poprawy)
...
//  BSP_LCD_FillCircle(350, 100, 100); // rysuje koło w punkcie (100, 100) o promieniu 50
//
//
//  // a teraz trapez:
...
//  trapezoidPoints[0].X = 150;
//  trapezoidPoints[0].Y = 0;
//
//  trapezoidPoints[1].X = 300;
//  trapezoidPoints[1].Y = 0;
//
//  trapezoidPoints[2].X = 225;
//  trapezoidPoints[2].Y = 140;
//
//  trapezoidPoints[3].X = 150;
//  trapezoidPoints[3].Y = 140;
//
//  BSP_LCD_SetTextColor(LCD_COLOR_BLUE); // niech będzie pomarańczowy
